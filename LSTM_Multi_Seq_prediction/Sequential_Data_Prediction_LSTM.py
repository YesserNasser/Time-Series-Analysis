...
'''========================================================================='''
'''============== loading data and config_param file  ======================'''
'''========================================================================='''
...
# ==================== plot multi sequence predictions ========================
def plot_results_multiple(predicted_data, true_data, prediction_len):
    ...
    plt.title('Results: Multiple Sequence Predictions')
    plt.xlabel('Days')
    plt.ylabel('Normalized Price (SP500)')
    plt.show()
# ==================== plot point by point predictions ========================     
def plot_results(predicted_data, true_data):
    ...
    plt.title('Results: Point-by_Point Predictions')
    plt.xlabel('Days')
    plt.ylabel('Normalized Price (SP500)')
    plt.show()
